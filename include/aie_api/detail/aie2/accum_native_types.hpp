...
template <unsigned N> requires (N >= 64) struct accum_storage<AccumClass::Int,  32,   N> : compound_accum_storage<N, accum_storage<AccumClass::Int, 32, 32>> {};
...
template <unsigned N> requires (N >= 32) struct accum_storage<AccumClass::Int,  64,   N> : compound_accum_storage<N, accum_storage<AccumClass::Int, 64, 16>> {};
...
template <unsigned N> requires (N >= 16) struct accum_storage<AccumClass::CInt, 64,   N> : compound_accum_storage<N, accum_storage<AccumClass::CInt, 64, 8>> {};
...
template <unsigned N> requires (N >= 64) struct accum_storage<AccumClass::FP,   32,   N> : compound_accum_storage<N, accum_storage<AccumClass::FP, 32, 32>> {};
...
template <unsigned N> requires (N >= 32) struct accum_storage<AccumClass::CFP,  32,   N> : compound_accum_storage<N, accum_storage<AccumClass::CFP, 32, 16>> {};
#endif
